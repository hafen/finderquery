...
We can use any valid Solr specification of term combinations See [here](https://lucene.apache.org/solr/guide/6_6/the-standard-query-parser.html#TheStandardQueryParser-SpecifyingTermsfortheStandardQueryParser) for more information. For example, for documents that contain the category "CoronavirusInfection" AND the category "PAHO":
